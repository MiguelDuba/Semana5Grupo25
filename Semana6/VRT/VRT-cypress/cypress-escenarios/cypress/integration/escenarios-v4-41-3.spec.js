...
describe('Escenarios v4.41.3', () => {
    ...
    it('escenario 7: Editar una página sin guardar', () => {
        ...
        //Se crea una página para asegurarse de que exista una página para editar
    ...
    it('Cambiar contraseña con valores diferentes en contraseña nueva y verificación de contraseña', () => {
         ...
         cy.visit("http://localhost:2368/ghost/#/settings/staff/sara")
         cy.wait(2000)
